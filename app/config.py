...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.default_reward_per_post: int = int(os.getenv("DEFAULT_REWARD_PER_POST", "1"))
        self.default_reward_per_found_item: int = int(os.getenv("DEFAULT_REWARD_PER_FOUND_ITEM", "0.05"))
